...
{phang2}{cmd:. import excel "https://raw.githubusercontent.com/timbulwidodostp/limpe_re/main/limpe_re/limpe_re.xlsx", sheet("Sheet1") firstrow clear}{p_end}
	{phang2}{cmd:. limpe_re governing safety education, groupid(noleft) }{p_end}	
{phang2}{cmd:. limpe_re governing safety education, groupid(noleft) avevar(safety education) }{p_end}
...
{phang}https://www.youtube.com/@amalsedekah/videos{p_end}
{phang}https://github.com/timbulwidodostp{p_end}	{phang}Guido Kuersteiner{p_end}
